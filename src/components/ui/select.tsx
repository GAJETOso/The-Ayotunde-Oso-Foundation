...
>(({ className, children, error, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-11 w-full items-center justify-between rounded-xl border bg-white px-4 py-2 text-sm',
      'ring-offset-white placeholder:text-neutral-400 transition-all duration-200',
      'focus:outline-none focus:ring-2 focus:ring-offset-0',
      'disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
      'dark:bg-neutral-950 dark:text-neutral-100',
      error
        ? 'border-red-500 focus:ring-red-500/30'
        : 'border-neutral-300 focus:border-brand-500 focus:ring-brand-500/20 dark:border-neutral-700',
      className
    )}
    {...props}
  >
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        'relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-2xl border border-neutral-200 bg-white text-neutral-950 shadow-floating',

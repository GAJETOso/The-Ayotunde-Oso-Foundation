  ...
  return (
    <main id="main-content">
      <PageHero
        ...
        gradient="brand"
      >
        <Button variant="gold" size="lg" asChild><Link href="/donate?program=environment">Plant a Tree Today</Link></Button>
        <Button variant="outline-white" size="lg" asChild><Link href="/volunteer">Join Green Corps</Link></Button>
      </PageHero>
        ...
        <div className="container-xl">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[4/3]">
              <Image src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=800&q=80" alt="AOF tree planting initiative" fill className="object-cover" />
            </div>
            <div>
              ...
              {['250,000+ trees planted across 4 Nigerian states', 'Solar-powered clean water points in 30 communities', 'Youth Green Corps: 5,000 trained climate advocates', 'Plastic waste collection partnerships in 8 cities'].map(item => (
      ...
      <section className="section bg-emerald-700">
        <div className="container-xl text-center">
          ...
          <p className="text-emerald-200 mb-8 max-w-xl mx-auto">$10 plants and nurtures a tree for three years. $100 provides a family with clean water access. $500 trains a community climate champion.</p>
          <div className="flex flex-wrap justify-center gap-4">
            <Button variant="white" size="lg" asChild><Link href="/donate?program=environment">Plant Trees Now</Link></Button>
            <Button variant="outline-white" size="lg" asChild><Link href="/volunteer">Join Green Corps</Link></Button>
          </div>
        </div>
      </section>

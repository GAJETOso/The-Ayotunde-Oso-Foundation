  ...
  return (
    <main id="main-content">
      <PageHero
        ...
        gradient="dark"
      >
        <Button variant="gold" size="lg" asChild><Link href="/donate?program=emergency">Donate to Relief Fund</Link></Button>
        <Button variant="outline-white" size="lg" asChild><Link href="/volunteer">Emergency Volunteer</Link></Button>
      </PageHero>
        ...
        <div className="container-xl">
          <div className="grid lg:grid-cols-4 gap-6 mb-16">
            {[
              ...
              <Card key={s.label} className="p-6 text-center">
                <p className="text-4xl font-bold font-display text-orange-600">{s.value}</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              {['Pre-positioned emergency supplies in 6 states', '72-hour first-response SLA for all declarations', 'Dedicated emergency response reserve fund', 'Post-crisis rehabilitation and psychosocial support'].map(item => (
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl aspect-[4/3]">
              <Image src="https://images.unsplash.com/photo-1593113598332-cd288d649433?w=800&q=80" alt="AOF emergency relief distribution" fill className="object-cover" />
            </div>
          </div>
      ...
      <section className="section bg-orange-700">
        <div className="container-xl text-center">
          ...
          <p className="text-orange-200 mb-8 max-w-xl mx-auto">
            Unrestricted donations to our Emergency Relief Fund allow us to respond the moment a crisis emerges — without waiting for programme-specific approvals.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <Button variant="white" size="lg" asChild><Link href="/donate?program=emergency">Give to Relief Fund</Link></Button>
            <Button variant="outline-white" size="lg" asChild><Link href="/campaigns">See Active Campaigns</Link></Button>
          </div>
        </div>
      </section>
    </main>

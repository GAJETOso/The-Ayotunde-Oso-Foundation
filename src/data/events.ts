...
export const EVENTS: Event[] = [
  ...
  },
  {
    ...
    description:
      "AOF's first-ever fundraising gala celebrated the foundation's launch and secured key partnerships. Over 180 guests attended at Eko Hotel, raising ₦6.2M for programme expansion.",
    date: '2025-11-15',
  ...
  },
  {
    ...
    description:
      "340 volunteers joined AOF's inaugural tree-planting campaign across seven communities in Lagos and Ogun states, planting 1,850 trees in a single weekend.",
    date: '2025-12-06',
